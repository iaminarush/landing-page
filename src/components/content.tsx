  ...
  return (
    <>
      ...
      {/* <motion.div
        ...
        className="fixed bottom-8 ml-auto mr-auto left-0 right-0"
      >
        <div className="flex space-x-2 justify-center">
          <a href="https://github.com/iaminarush" target="_blank">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="fill-gray-200 hover:fill-gray-400 cursor-pointer z-20"
              viewBox="0 0 512 512"
              width="28px"
              height="28px"
              id="githubSVG"
          ...
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="stroke-gray-200 hover:stroke-gray-400 z-20"
              viewBox="0 0 512 512"
              width="28px"
              height="28px"
            >
